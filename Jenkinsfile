pipeline {
    ...
    stages {
        ...
        stage('Build') {
            steps {
                bat "C:/Users/lucas/AppData/Local/Programs/Python/Python310/Scripts/python.exe -m install --upgrade pip"
                bat "C:/Users/lucas/AppData/Local/Programs/Python/Python310/Scripts/python.exe install --upgrade wheel"
                bat "C:/Users/lucas/AppData/Local/Programs/Python/Python310/Scripts/python.exe install --upgrade setuptools"
